...
MSG_EVENT_FR      = "Ismétlődjön az esemény minden (n)ap, (h)ét, (hó)nap vagy (é)v? "
MSG_EVENT_IMP     = "Események importálása Calcurse-ból? (i/n)"
...
MSG_TS_DEL_ALL    = "Valóban minden feladatot törölni? (i/n)"
MSG_TS_EDT_ALL    = "Megerősíted a műveletet? (i/n)"
...
MSG_TS_IM         = "Feladatok importálása Calcurse-ból? (i/n)"
MSG_TS_TW         = "Feladatok importálása Taskwarriorból? (i/n)"
